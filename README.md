![CI](https://github.com/PavithraBalan/jhipster-new-application/workflows/CI/badge.svg)

# jhipster New Application
...
To build the final jar and optimize the jhipsterNewApplication application for production, run:
